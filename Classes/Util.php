<?
	class Util{
		...
		function cleanString( $string, $rep_white = "_", $isText = false )
		{
		...
		function scoateDiacritice( $string )
		{
			$accented = array(
				'À', 'Á', 'Â', 'Ã', 'Ä', 'Å', 'Æ', 'Ă', 'Ą',
				'Ç', 'Ć', 'Č', 'Œ',
		...
		function corecteazaDiacritice( $string )
		{
		...
		function arrayRemoveEmptyVals( $array = array() )
		{
			$ret = array();
			foreach( $array as $a )
			{
		...
		function GetCurrentUrlReplacingVal($key,$val){
