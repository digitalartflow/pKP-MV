...
<input name="IdManufacturer" value="1" type="hidden" />
...
<tr>
	...
	<td nowrap="nowrap"><strong>Dealer Price:</strong></td>

	<td colspan="2"><input type="text" name="Price" value="{{$item.Price|default:0}}" style="width:150px" /></td>

</tr>
<tr>

	<td nowrap="nowrap"><strong>Retail price percentage:</strong></td>

	<td colspan="2">+ <input type="text" name="RetailPricePercentage" value="{{$item.RetailPricePercentage|default:0}}" style="width:75px" />%</td>
