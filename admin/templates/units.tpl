...
<fieldset style="margin-bottom:5px; float:left; width:45%">
<legend><strong>Import / Export:</strong></legend>
<form method="post" action="?page=units&import" enctype="multipart/form-data">
<input type="hidden" name="action" value="import" />
<table width="100%" cellpadding="5" cellspacing="1">
<tr>
	<td><strong>File:</strong></td>
	<td width="100%"><input type="file" name="file" value="" /></td>
	<td align="center"><input type="submit" value="Import" /></td>
</tr>
<tr>
	<td align="left" colspan="3"><a href="?page=units&export">Export units and variations</a></td>
</tr>
</table>
</form>
</fieldset>
<fieldset style="margin-bottom:5px; float:right; width:45%">
...
<tr bgcolor="#000000" style="color:#FFF">
	...
	<th align="left" nowrap="nowrap">Price from</th>
...
<tr bgcolor="{{cycle values='#EEE,#CCC'}}">
	...
	<td><strong>{{$n.Price}}</strong><br /><strong>{{$n.RetailPricePercentage}}%</strong></td>
