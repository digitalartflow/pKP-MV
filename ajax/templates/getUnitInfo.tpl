...
<tr>
	...
	<td valign="top" align="center"><img id="imgPreviewUnitInfo" src="{{$smarty.const.WEBSITE_URL}}uploads/unit_u{{$uv.Id}}_h{{$smarty.session.getUnitsPost.h}}_t{{$ut.Id}}_a0.png" height="100" />
    ...
    <div class="price">
    	...
    	<strong><sup>INR</sup>{{$price}}</strong> 
