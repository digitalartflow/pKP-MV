{{foreach from=$items item=n}}
    ...
    <strong style="font-size:24px; display:block; float:left; color:#006600">INR {{$n.FinalPrice}}</strong><input type="button" value="Add unit" onclick='addUnit({{$n.Id}},"{{$n.JSON_DATA}}")' style="background:#006600; color:#FFFFFF; border:0px; float:right; border-radius:3px; padding:4px 8px 4px 8px; cursor:pointer" /></td>
    </tr>
    </table>
    </div>
{{/foreach}}