...
<h1 class="ui-dialog-titlebar ui-widget-header ui-corner-all title" style="font-size:16px; margin-bottom:10px">Please Specify State of India</h1>
...
<tr>
    <td>Postal Code:</td>
    <td><input type="text" name="postal_code" value="0" style="width:50px" /></td>
</tr>
</table>
</form>
