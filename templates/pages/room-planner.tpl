...
{{$header}}
<div id="shoppingCartHolder" style="position:fixed; right:500px; font-size:12px; top:0px; border:0px; color:#000; font-weight:bold; padding:2px; cursor:pointer;" align="center" onclick="showShoppingCart()">Cart (<span id="scCounter" style="color:#A06F0F">0</span>) Items <img src="images/shoopingCart.png" height="15" /></div>
<div id="bottomToolbar" style="position:fixed; left:0px; top:36px; width:200px; background:#000000; padding:5px; border-right:1px solid #333333" align="left">
<div style="overflow:hidden">
<a onclick="$('#btName').toggle()" class="btnRed">Show/Hide Filters</a>
<a onclick="initChooseStyle()" class="btnRed">Other Styles</a>
</div>
...
<h4>Range ({{$textures|@count}} available)</h4>
...
<h4>Range ({{$n.textures|@count}} available)</h4>
<div class="slider_holder">
<div class="slides_holder">
...
<tr>
<td width="50%" align="center" valign="bottom" style="color:#ffffff">
...
if( firstStyleChoosed ) buttons['View units'] = function(){selectStyle(hid)};
...
function initFlashSoftware(flashvars,params,attributes){
	...
	flashvars.cur_domain = window.location.host;
...
width:24px;
height:24px;
background:url({{$smarty.const.WEBSITE_URL}}images/room_planner/ok-icon.png) center no-repeat;
...
background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #939393), color-stop(1, #6d6d6d) );
background:-moz-linear-gradient( center top, #939393 5%, #fd9090 100% );
filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#939393', endColorstr='#6d6d6d');
...
.btnRed:hover {
background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #6d6d6d), color-stop(1, #939393) );
background:-moz-linear-gradient( center top, #6d6d6d 5%, #939393 100% );
filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#6d6d6d', endColorstr='#939393');
...
var carcase = {{$saved_room_style.carcase|default:$dps.carcasses.0.Id|default:0}};
var unitDoorType = {{$saved_room_style.unitDoorType|default:$dps.doors.0.Id|default:0}};
var texture = {{$saved_room_style.texture|default:$dps.textures.0.Id|default:0}};
var toptexture = {{$saved_room_style.toptexture|default:$dps.top_textures.0.Id|default:0}};
var handle = {{$saved_room_style.handle|default:$dps.handles.0.Id|default:0}};
